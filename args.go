...
const usage = `Usage: zlc [FLAGS] [FILE1] [FILE2]
...
When compressing and only FILE1 is given, FILE2 is FILE1.zl .
When decompressing and only FILE1 is given, FILE2 tries to strip .zl from it.
